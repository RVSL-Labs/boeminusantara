...
export default async function PortalHome() {
  ...
  const perluTindakan = quotes.filter((q) => q.status === "negotiating").length;
    ...
    <div className="space-y-10">
      <header>
        ...
        <p className="mt-1 text-sm text-[var(--color-ink-soft)]">
          {perluTindakan > 0
            ? `${perluTindakan} penawaran menunggu tanggapan Anda.`
            : "Riwayat permintaan penawaran dan pesanan Anda."}
        </p>
      </header>
